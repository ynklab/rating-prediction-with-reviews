...
ORIGINAL_SCORE_CASE_TEMPLATE = """[The Start of Book Description {n}]
{description}
[The End of Book Description {n}]
[Review]
```json
{{
  "Review": "{review}",
...
NOREVIEWS_SCORE_CASE_TEMPLATE = """[The Start of Book Description {n}]
{description}
[The End of Book Description {n}]
[Review]
```json
...
NOREVIEW_SCORE_PROBLEM_PROMPT_TEMPLATE = """[User Question] You will be presented with several book descriptions, each accompanied by a review from the same user. Your task is to analyze both the descriptions and the corresponding reviews to discern the reviewer's preferences. Afterward, consider a new book description and create a review that you believe this reviewer would write based on the established preferences. 
...
KAR_PREFERENCE_REASONING_TEMPLATE = """A user's past book reviews are listed below:
...
SCORESUMM_REASONING_TEMPLATE = """A user's past book reviews are listed below:
...
SCORESUMM_SCORE_PROBLEM_PROMPT_TEMPLATE = """[User Question] You will be presented with several book descriptions, each accompanied by a review from the same user. Your task is to analyze both the descriptions and the corresponding reviews to discern the reviewer's preferences. Afterward, consider a new book description and create a review that you believe this reviewer would write based on the established preferences. 
